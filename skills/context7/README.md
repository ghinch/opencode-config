...
- **ExternalScout**: `~/.config/opencode/agents/externalscout.md` (global) or `.opencode/agents/externalscout.md` (project)—create the file if you use this subagent; OpenCode loads agent defs from `agents/*.md`.
- **ContextScout**: `~/.config/opencode/agents/contextscout.md` or `.opencode/agents/contextscout.md` (same convention).
